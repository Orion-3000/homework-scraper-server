...
def get_sheet(sheet_id: str, creds_json_path: str):
    scopes = [
...
def run_scraper(email: str, password: str, sheet_link: str, progress_callback=None):
    creds_json_path = os.getenv("CREDS_JSON", "creds.json")
    ...
    with sync_playwright() as p:
        ...
        update_progress(0.15, "Opening sign-in flow")

        sign_in_page = page

        # Case 1: already on a page with email input
    ...
    sheet = get_sheet(sheet_id, creds_json_path)
    sheet.clear()
